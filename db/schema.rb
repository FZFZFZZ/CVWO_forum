...
ActiveRecord::Schema[7.1].define(version: 2024_01_06_165200) do
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.string "instagram"
    t.string "phone"
    t.boolean "favshare", default: true
    t.boolean "contactshare", default: true
    t.boolean "historyshare", default: true
